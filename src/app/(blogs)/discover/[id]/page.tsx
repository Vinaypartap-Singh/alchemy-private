...
export default function SingleBlogInfo({ params }: any) {
  ...
  const userDetails = blog?.userinfo;
  ...
  return (
    <div className="bg-black text-white">
      ...
      <div className="max-w-4xl m-auto mt-16">
        ...
        <h1 className="text-3xl mt-6 leading-10">{blog.title}</h1>
        ...
        <div className="mt-6 p-4 rounded-lg">
          <div className="flex items-center justify-between">
            ...
            <div>
              <Button
                className="bg-[#431E1C] text-red-700 hover:bg-[#301412]"
                asChild
              >
        ...
        <div className="mt-6 p-4 flex flex-col gap-6 text-[#959595] text-xl">
          <p
            className={`flex flex-col gap-6 ${noto.className} content`}
